...
<%
	If Request.Form() <> "" Then
        ...
        fldFinishDate               = Request.Form("fldFinishDate")
            ...
            '# Kayıt İşlemi
			SQL.Execute("Insert Into tblProjects (fldUserID, fldDurum, fldProjectName, fldProjectDesc, fldStartDate, fldFinishDate) Values ("& SET_ADMIN_ID &", 0, '"& fldProjectName &"', '"& fldProjectDesc &"', CONVERT(DATE, '"& FormatDateTime(fldStartDate) &"', 104), CONVERT(DATE, '"& FormatDateTime(fldFinishDate) &"', 104))")
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" placeholder="Proje Adı" name="fldProjectName" id="fldProjectName" required>
                                                    </div>
                                                </div>
                                            </div>                                            
											<div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <textarea class="form-control" placeholder="Proje Açıklaması" name="fldProjectDesc" id="fldProjectDesc"></textarea>
                                                    </div>
                                                </div>
                                            </div>
